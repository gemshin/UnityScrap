...
public static class DebugExtension
{
    ...
    public static void DebugCapsule(Vector3 center, Color color, float height = 1, float radius = 1)
    {
        ...
        Vector3 start = center + (Vector3.up * sideLength);
        Vector3 end = center + (Vector3.down * sideLength);
    ...
    public static void DrawCapsule(Vector3 center, Color color, float height, float radius = 1)
    {
        ...
        Vector3 start = center + (Vector3.down * sideLength);
